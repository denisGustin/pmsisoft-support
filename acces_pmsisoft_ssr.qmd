...
- Données PMSI SSR retraitées `r gen_fn(1, "fn1")`
- Bases d'activité avec zoom aux rhs `r gen_fn(2, "fn2")`
...
- Bibliothèque de requêtes PMSI SSR
- Rapports d'activité PMSI SSR basiques, téléchargeables en pdf
...
- Accès proposé à  tout établissement de santé sanitaire SSR `r gen_fn(6, "fn6")`
- Accès en ligne en HDS
- Multi-accès, multi-finess, multi-champs PMSI
- Accès DIM sous la responsabilité du médecin DIM de l'établissement
- Accès Administratif (données consolidées, sans accès à des données PMSI individualisées ou indirectement individualisées)
...
- Données PMSI SSR enrichies`r gen_fn(5, "fn5")`
...
- Requêteur métier PMSI SSR `r gen_fn(4, "fn4")`
...
<footer>
  ...
  <ol  style="padding-left: 1rem;">
    ...
    <li id="fn2">avec les seules variables des formats PMSI SSR. Accès aux variables calculées ou enrichies dans l'accès Professionnel</li>
