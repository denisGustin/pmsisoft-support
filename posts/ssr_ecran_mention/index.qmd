---
title: "Ecran Mention SSR"
description: |
  Analyses PMSI du décret des mentions SSR
author: denis G
date: "2023-05-16"
categories: [SSR, Ecran]
page-layout: full
---
...
Une partie importante de ces caractéristiques peut être raisonnablement traduite en PMSI SSR afin de permettre aux établissements d'analyser et de travailler sur la **cohérence à minima** de leurs pratiques de soins, vues du PMSI SSR, avec les exigences des mentions SMR qui leur sont octroyées.  

L'attribution des mentions SSR à chaque séjour HC terminé et chaque semaine HP dans PMSISoft est cohérente avec les codes des autorisations actuelles. [^1]  
...
**Chemin de l'écran : Analyse SSR > Mentions**  
...
Remarque : ce casemix est aussi intéressant, indépendamment du sujet des mentions SSR, pour analyser toutes les configurations rencontrées d'intervenants par séjour dans l'établissement.  
...
Ce séjour a 48 journées de présence (au sens PMSI SSR) en jour ouvré, dont 46 avec au moins 1 acte CSARR réalisé (ce qui représente 95,83% des jours de présence en jour ouvré) et 2 avec 0 acte CSARR codé.  
...
Accès Professionnel SSR.  

Pour plus d'informations ou une démonstration, nous [contacter](https://www.lespmsi.com/a-propos-2/#Formulaire_de_contact)  
